...
def log_in(request):
    ...
    # Redis connection error
        ...
        logger.error("OAUTH2::log_in: Application with id '{}' not found : {}".format(request.POST.get('app_id', None), str(e)))
...
def is_valid_token(request):
    if request.POST:
        try:
            ...
            logger.debug("OAuth2Portal::is_valid_token: Token retrieven in POST datas")
        ...
        try:
            ...
            logger.debug("OAuth2Portal::is_valid_token: Oauth2 datas successfully retrieven in Redis : {}".format(data))
