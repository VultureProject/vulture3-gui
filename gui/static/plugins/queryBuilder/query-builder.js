...
function(a, b) {
    ...
    function e(a, c) {
        var d;
        return d = c.closest(g.rule_container), d.length ? void a.moveAfter(b(d)) : (d = c.closest(g.group_header), d.length ? (d = c.closest(g.group_container), void a.moveAtBegin(b(d))) : (d = c.closest(g.group_container), d.length ? void a.moveAtEnd(b(d)) : void 0))
    }
    var f = function(a, b) {
        this.init(a, b)
    };
    $.extend(f.prototype, {
    ...
    }), f.plugins = {}, f.defaults = function(a) {
        return "object" != typeof a ? "string" == typeof a ? "object" == typeof f.DEFAULTS[a] ? $.extend(!0, {}, f.DEFAULTS[a]) : f.DEFAULTS[a] : $.extend(!0, {}, f.DEFAULTS) : void $.extendext(!0, "replace", f.DEFAULTS, a)
    ...
    }, f.prototype.initPlugins = function() {
        if (this.plugins) {
            ...
            Object.keys(this.plugins).forEach(function(a) {
                a in f.plugins ? (this.plugins[a] = $.extend(!0, {}, f.plugins[a].def, this.plugins[a] || {}), f.plugins[a].fct.call(this, this.plugins[a])) : k.error("Config", 'Unable to find plugin "{0}"', a)
            }, this)
        }
    }, f.types = {
        string: "string",
        ...
        datetime: "datetime",
        "boolean": "boolean"
    }, f.inputs = ["text", "textarea", "radio", "checkbox", "select"], f.modifiable_options = ["display_errors", "allow_groups", "allow_empty", "default_condition", "default_filter"];
    var g = f.selectors = {
    ...
    f.templates = {}, f.regional = {}, f.OPERATORS = {
            equal: {
                type: "equal",
                nb_inputs: 1,
                multiple: !1,
            ...
            c[0].queryBuilder = this, this.$el = c, this.settings = $.extendext(!0, "replace", {}, f.DEFAULTS, d), this.model = new b, this.status = {
                group_id: 0,
                rule_id: 0,
                generated_id: !1,
                has_optgroup: !1,
                ...
                id: null,
                updating_value: !1
            }, this.settings.allow_groups === !1 ? this.settings.allow_groups = 0 : this.settings.allow_groups === !0 && (this.settings.allow_groups = -1), this.filters = this.settings.filters, this.icons = this.settings.icons, this.operators = this.settings.operators, this.templates = this.settings.templates, this.plugins = this.settings.plugins, void 0 === f.regional.en && k.error("Config", '"i18n/en.js" not loaded.'), this.lang = $.extendext(!0, "replace", {}, f.regional.en, f.regional[this.settings.lang_code], this.settings.lang), Object.keys(this.templates).forEach(function(b) {
                this.templates[b] || (this.templates[b] = f.templates[b]), "string" == typeof this.templates[b] && (this.templates[b] = a.template(this.templates[b]))
            ...
            }, this), this.status.has_optgroup && (a = k.groupSort(a, "optgroup")), a
        }, f.prototype.checkOperators = function(a) {
            var b = [];
            ...
            var a = this;
            this.$el.on("change.queryBuilder", g.group_condition, function() {
                if ($(this).is(":checked")) {
                    var a = $(this).closest(g.group_container);
                    b(a).condition = $(this).val()
                }
            }), this.$el.on("change.queryBuilder", g.rule_filter, function() {
                var c = $(this).closest(g.rule_container);
                b(c).filter = a.getFilterById($(this).val())
            }), this.$el.on("change.queryBuilder", g.rule_operator, function() {
                var c = $(this).closest(g.rule_container);
                b(c).operator = a.getOperatorByType($(this).val())
            }), this.$el.on("click.queryBuilder", g.add_rule, function() {
                var c = $(this).closest(g.group_container);
                a.addRule(b(c))
            }), this.$el.on("click.queryBuilder", g.delete_rule, function() {
                var c = $(this).closest(g.rule_container);
                a.deleteRule(b(c))
            }), 0 !== this.settings.allow_groups && (this.$el.on("click.queryBuilder", g.add_group, function() {
                var c = $(this).closest(g.group_container);
                a.addGroup(b(c))
            }), this.$el.on("click.queryBuilder", g.delete_group, function() {
                var c = $(this).closest(g.group_container);
                a.deleteGroup(b(c))
            })), this.model.on({
                drop: function(a, b) {
                ...
                add: function(a, b, c) {
                    0 === c ? b.$el.prependTo(b.parent.$el.find(">" + g.rules_list)) : b.$el.insertAfter(b.parent.rules[c - 1].$el)
                },
                move: function(a, b, c, d) {
                    b.$el.detach(), 0 === d ? b.$el.prependTo(c.$el.find(">" + g.rules_list)) : b.$el.insertAfter(c.rules[d - 1].$el)
                },
        ...
        }, f.prototype.setRoot = function(a, b) {
            a = void 0 === a || a === !0;
            var c = this.nextGroupId(),
                d = $(this.getGroupTemplate(c, 1));
            return this.$el.append(d), this.model.root = new i(null, d), this.model.root.model = this.model, this.model.root.condition = this.settings.default_condition, this.model.root.flags = $.extend({}, this.settings.default_group_flags), void 0 !== b && (this.model.root.data = b), a && this.addRule(this.model.root), this.model.root
        }, f.prototype.addGroup = function(a, b, c, d) {
            b = void 0 === b || b === !0;
            var e = a.level + 1,
            ...
            var g = this.nextGroupId(),
                ...
                i = a.addGroup(h);
            return void 0 !== c && (i.data = c), i.flags = $.extend({}, this.settings.default_group_flags, d), this.trigger("afterAddGroup", i), i.condition = this.settings.default_condition, b && this.addRule(i), i
        }, f.prototype.deleteGroup = function(a) {
        ...
        }, f.prototype.updateGroupCondition = function(a) {
            a.$el.find(">" + g.group_condition).each(function() {
                var b = $(this);
                b.prop("checked", b.val() === a.condition), b.parent().toggleClass("active", b.val() === a.condition)
            }), this.trigger("afterUpdateGroupCondition", a)
        }, f.prototype.addRule = function(a, b, c) {
        ...
        }, f.prototype.deleteRule = function(a) {
        ...
        }, f.prototype.createRuleFilters = function(a) {
            var b = this.change("getRuleFilters", this.filters, a),
                c = $(this.getRuleFilterSelect(a, b));
            a.$el.find(g.filter_container).html(c), this.trigger("afterCreateRuleFilters", a)
        }, f.prototype.createRuleOperators = function(a) {
            var b = a.$el.find(g.operator_container).empty();
            if (a.filter) {
        ...
        }, f.prototype.createRuleInput = function(a) {
            var b = a.$el.find(g.value_container).empty();
        ...
        }, f.prototype.updateRuleFilter = function(a) {
            this.createRuleOperators(a), this.createRuleInput(a), a.$el.find(g.rule_filter).val(a.filter ? a.filter.id : "-1"), this.trigger("afterUpdateRuleFilter", a)
        }, f.prototype.updateRuleOperator = function(a, b) {
            var c = a.$el.find(g.value_container);
            a.operator && 0 !== a.operator.nb_inputs ? (c.show(), (c.is(":empty") || a.operator.nb_inputs !== b.nb_inputs) && this.createRuleInput(a)) : (c.hide(), a.__.value = void 0), a.operator && a.$el.find(g.rule_operator).val(a.operator.type), this.trigger("afterUpdateRuleOperator", a)
        }, f.prototype.updateRuleValue = function(a) {
            this.status.updating_value || this.setRuleValue(a, a.value), this.trigger("afterUpdateRuleValue", a)
        }, f.prototype.applyRuleFlags = function(a) {
            var b = a.flags;
            b.filter_readonly && a.$el.find(g.rule_filter).prop("disabled", !0), b.operator_readonly && a.$el.find(g.rule_operator).prop("disabled", !0), b.value_readonly && a.$el.find(g.rule_value).prop("disabled", !0), b.no_delete && a.$el.find(g.delete_rule).remove(), this.trigger("afterApplyRuleFlags", a)
        }, f.prototype.applyGroupFlags = function(a) {
            var b = a.flags;
            b.condition_readonly && (a.$el.find(">" + g.condition_container + " .btn").addClass("disabled"), a.$el.find(">" + g.group_condition).prop("disabled", !0)), b.no_delete && a.$el.find(g.delete_group).remove(), this.trigger("afterApplyGroupFlags", a)
        }, f.prototype.clearErrors = function(a) {
            ...
            if (this.settings.display_errors)
                if (null === a.error) a.$el.removeClass("has-error");
                    ...
                    a.$el.addClass("has-error").find(g.error_container).eq(0).attr("title", k.fmt.apply(null, b))
                }
        }, f.prototype.triggerValidationError = function(a, b, c) {
            $.isArray(b) || (b = [b]);
            ...
            $.makeArray($(Object.keys(a)).filter(f.modifiable_options)).forEach(function(b) {
                this.settings[b] = a[b]
            }, this)
        }, f.prototype.getModel = function(a) {
        ...
        }, f.prototype.getRules = function(a) {
            if (a = $.extend({
                    get_flags: !1
        ...
        }, f.prototype.setRules = function(a) {
            $.isArray(a) && (a = {
                condition: this.settings.default_condition,
                rules: a
            }), a && a.rules && (0 !== a.rules.length || this.settings.allow_empty) || k.error("RulesParse", "Incorrect data object passed"), this.clear(), this.setRoot(!1, a.data), this.model.root.flags = this.parseGroupFlags(a), a = this.change("setRules", a);
            var b = this;
            ! function c(a, d) {
                null !== d && (void 0 === a.condition ? a.condition = b.settings.default_condition : -1 == b.settings.conditions.indexOf(a.condition) && k.error("UndefinedCondition", 'Invalid condition "{0}"', a.condition), d.condition = a.condition, a.rules.forEach(function(a) {
                    var e;
                    if (a.rules && a.rules.length > 0)
                        if (-1 !== b.settings.allow_groups && b.settings.allow_groups < d.level) b.reset(), k.error("RulesParse", "No more than {0} groups are allowed", b.settings.allow_groups);
                        else {
                            if (e = b.addGroup(d, !1, a.data), null === e) return;
                            e.flags = b.parseGroupFlags(a), c(a, e)
                        }
                    else {
                        if (void 0 === a.id && k.error("RulesParse", "Missing rule field id"), void 0 === a.operator && (a.operator = "equal"), e = b.addRule(d, a.data), null === e) return;
        ...
        }, f.prototype.validateValue = function(a, b) {
        ...
        }, f.prototype.validateValueInternal = function(a, b) {
            var c, d = a.filter,
                e = a.operator,
                g = d.validation || {},
                h = !0;
                    ...
                    default:
                        switch (f.types[d.type]) {
                            ...
                            case "number":
                                ...
                                if (void 0 !== g.step && "any" !== g.step) {
                                    var j = (b[i] / g.step).toPrecision(14);
                                    if (parseInt(j) != j) {
            ...
            for (var b = [], c = 0, d = this.operators.length; d > c; c++) {
                ...
                } else if (-1 == this.operators[c].apply_to.indexOf(f.types[a.type])) continue;
            ...
            k.error("UndefinedFilter", 'Undefined filter "{0}"', a)
            ...
            k.error("UndefinedOperator", 'Undefined operator "{0}"', a)
        }, f.prototype.getRuleValue = function(a) {
            var b = a.filter,
                c = a.operator,
                d = [];
            if (b.valueGetter) d = b.valueGetter.call(this, a);
            else {
                for (var e = a.$el.find(g.value_container), f = 0; f < c.nb_inputs; f++) {
        ...
        }, f.prototype.setRuleValue = function(a, b) {
            var c = a.filter,
                d = a.operator;
            if (c.valueSetter) c.valueSetter.call(this, a, b);
            else {
                var e = a.$el.find(g.value_container);
                b = 1 == d.nb_inputs ? [b] : b;
                for (var f = 0; f < d.nb_inputs; f++) {
                    ...
                    switch (c.input) {
                        ...
                        case "checkbox":
                            ...
                            break;
                        default:
                            e.find("[name=" + h + "]").val(b[f]).trigger("change")
                    }
                }
            }
        }, f.prototype.parseRuleFlags = function(a) {
        ...
        }, f.prototype.getGroupFlags = function(a, b) {
            if (b) return $.extend({}, a);
            var c = {};
            return $.each(this.settings.default_group_flags, function(b, d) {
                a[b] !== d && (c[b] = a[b])
            }), c
        }, f.prototype.translateLabel = function(a) {
            return "string" == typeof a ? a : a[this.settings.lang_code] || a.en
        }, f.templates.group = '<dl id="{{= it.group_id }}" class="rules-group-container"><dt class="rules-group-header"><div class="btn-group pull-right group-actions"><a class="addplus_logs" data-add="rule">{{= it.lang.add_rule }}</a>{{? it.settings.allow_groups===-1 || it.settings.allow_groups>=it.level }}<a class="addplus_logs" data-add="group">{{= it.lang.add_group }}</a>{{?}}{{? it.level>1 }}<a class="delbtn" data-delete="group"><i class="{{= it.icons.remove_group }}"></i></a>{{?}}</div><div class="btn-group group-conditions">{{~ it.conditions: condition }}<label class="btn btn-xs btn-primary">  <input type="radio" name="{{= it.group_id }}_cond" value="{{= condition }}"> {{= it.lang.conditions[condition] || condition }}</label>{{~}}</div>{{? it.settings.display_errors }}<div class="error-container"><i class="{{= it.icons.error }}"></i></div>{{?}}</dt><dd class=rules-group-body><ul class=rules-list></ul></dd> </dl>', f.templates.rule = '<li id="{{= it.rule_id }}" class="rule-container"><div class="rule-header"><div class="btn-group pull-right rule-actions"><a class="delbtn" data-delete="rule"><i class="{{= it.icons.remove_rule }}"></i></a></div></div>{{? it.settings.display_errors }}<div class="error-container"><i class="{{= it.icons.error }}"></i></div>{{?}}<div class="rule-filter-container"></div><div class="rule-operator-container"></div><div class="rule-value-container"></div> </li>', f.templates.filterSelect = '{{ var optgroup = null; }} <select class="form-control" name="{{= it.rule.id }}_filter">{{? it.settings.display_empty_filter }} <option value="-1">{{= it.settings.select_placeholder }}</option>   {{?}}   {{~ it.filters: filter }}     {{? optgroup !== filter.optgroup }}       {{? optgroup !== null }}</optgroup>{{?}}       {{? (optgroup = filter.optgroup) !== null }}         <optgroup label="{{= it.translate(it.settings.optgroups[optgroup]) }}">       {{?}}     {{?}}     <option value="{{= filter.id }}">{{= it.translate(filter.label) }}</option>   {{~}}   {{? optgroup !== null }}</optgroup>{{?}} </select>',
        f.templates.operatorSelect = '{{ var optgroup = null; }} <select class="form-control" name="{{= it.rule.id }}_operator">   {{~ it.operators: operator }}     {{? optgroup !== operator.optgroup }}       {{? optgroup !== null }}</optgroup>{{?}}       {{? (optgroup = operator.optgroup) !== null }}         <optgroup label="{{= it.translate(it.settings.optgroups[optgroup]) }}">       {{?}}     {{?}}     <option value="{{= operator.type }}">{{= it.lang.operators[operator.type] || operator.type }}</option>   {{~}}   {{? optgroup !== null }}</optgroup>{{?}} </select>', f.prototype.getGroupTemplate = function(a, b) {
        ...
        }, f.prototype.getRuleFilterSelect = function(a, b) {
        ...
        }, f.prototype.getRuleInput = function(a, b) {
            var c = a.filter,
                d = a.filter.validation || {},
                e = a.id + "_value_" + b,
                g = c.vertical ? " class=block" : "",
                h = "";
            if ("function" == typeof c.input) h = c.input.call(this, a, e);
                ...
                case "checkbox":
                    k.iterateOptions(c.values, function(a, b) {
                        h += "<label" + g + '><input type="' + c.input + '" name="' + e + '" value="' + a + '"> ' + b + "</label> "
                    });
                    break;
                case "select":
                    h += '<select class="form-control" name="' + e + '"' + (c.multiple ? " multiple" : "") + ">", c.placeholder && (h += '<option value="' + c.placeholder_value + '" disabled selected>' + c.placeholder + "</option>"), k.iterateOptions(c.values, function(a, b) {
            ...
            return a ? a instanceof h ? a : $(a).data("queryBuilderModel") : null
        };
    var h = function(a, b) {
        return this instanceof h ? (Object.defineProperty(this, "__", {
            value: {}
        }), b.data("queryBuilderModel", this), this.__.level = 0, this.__.error = null, this.__.data = void 0, this.$el = b, this.id = b[0].id, this.model = null, void(this.parent = a)) : new h
    };
    c(h, ["level", "error", "data", "flags"]), Object.defineProperty(h.prototype, "parent", {
        enumerable: !0,
        get: function() {
        ...
        null !== this.model && this.model.trigger("drop", this), this.isRoot() || (this.parent._removeNode(this), this.parent = null)
        ...
        return this.isRoot() ? void 0 : (void 0 === a && (a = this.parent), this._move(a, a.length()), this)
    }, h.prototype._move = function(a, b) {
    ...
    i.prototype = Object.create(h.prototype), i.prototype.constructor = i, c(i, ["condition"]), i.prototype.empty = function() {
    ...
    }, i.prototype._appendNode = function(a, b, c) {
        ...
        return this._appendNode(new i(this, a), b, !0)
    }, i.prototype.addRule = function(a, b) {
        return this._appendNode(new j(this, a), b, !0)
    }, i.prototype._removeNode = function(a) {
        ...
        for (var e = a ? this.rules.length - 1 : 0, f = a ? 0 : this.rules.length - 1, g = a ? -1 : 1, h = function() {
                return a ? e >= f : f >= e
            }, j = !1; h() && (this.rules[e] instanceof i ? void 0 !== c && (j = c.call(d, this.rules[e]) === !1) : j = b.call(d, this.rules[e]) === !1, !j); e += g);
        return !j
    ...
    var j = function(a, b) {
        return this instanceof j ? (h.call(this, a, b), this.__.filter = null, this.__.operator = null, this.__.flags = {}, void(this.__.value = void 0)) : new j(a, b)
    };
    j.prototype = Object.create(h.prototype), j.prototype.constructor = j, c(j, ["filter", "operator", "value"]), f.Group = i, f.Rule = j;
    var k = f.utils = {};
    k.iterateOptions = function(a, b) {
        ...
        var c = new Error(k.fmt.apply(null, Array.prototype.slice.call(arguments, 1)));
        ...
        this.length > 1 && k.error("Config", "Unable to initialize on multiple target");
        var b = this.data("queryBuilder"),
            c = "object" == typeof a && a || {};
        return b || "destroy" != a ? (b || this.data("queryBuilder", new f(this, c)), "string" == typeof a ? b[a].apply(b, Array.prototype.slice.call(arguments, 1)) : this) : this
    }, $.fn.queryBuilder.constructor = f, $.fn.queryBuilder.defaults = f.defaults, $.fn.queryBuilder.extend = f.extend, $.fn.queryBuilder.define = f.define, $.fn.queryBuilder.regional = f.regional, f.define("bt-checkbox", function(a) {
        ...
        font: "glyphicons",
        color: "default"
    }), f.define("bt-selectpicker", function(a) {
        $.fn.selectpicker && $.fn.selectpicker.Constructor || k.error("MissingLibrary", 'Bootstrap Select is required to use "bt-selectpicker" plugin. Get it here: http://silviomoreto.github.io/bootstrap-select'), this.on("afterCreateRuleFilters", function(b, c) {
            c.$el.find(g.rule_filter).removeClass("form-control").selectpicker(a)
        }), this.on("afterCreateRuleOperators", function(b, c) {
            c.$el.find(g.rule_operator).removeClass("form-control").selectpicker(a)
        }), this.on("afterUpdateRuleFilter", function(a, b) {
            b.$el.find(g.rule_filter).selectpicker("render")
        }), this.on("afterUpdateRuleOperator", function(a, b) {
            b.$el.find(g.rule_operator).selectpicker("render")
        })
    }, {
        container: "body",
        ...
        width: "auto",
        showIcon: !1
    }), f.define("bt-tooltip-errors", function(a) {
        ...
        this.on("getRuleTemplate.filter getGroupTemplate.filter", function(a) {
            var b = $(a.value);
            b.find(g.error_container).attr("data-toggle", "tooltip"), a.value = b.prop("outerHTML")
        }), this.model.on("update", function(c, d, e) {
            "error" == e && b.settings.display_errors && d.$el.find(g.error_container).eq(0).tooltip(a).tooltip("hide").tooltip("fixTitle")
        })
    }, {
        placement: "right"
    }), f.extend({
        setFilters: function(a, b) {
            ...
            if (a || ! function f(a) {
                    a.each(function(a) {
                        a.filter && -1 === d.indexOf(a.filter.id) && k.error("ChangeFilter", 'A rule is using filter "{0}"', a.filter.id)
                    }, f)
                }(this.model.root), this.filters = b, function h(a) {
                    a.each(!0, function(a) {
                        a.filter && -1 === d.indexOf(a.filter.id) ? a.drop() : (c.createRuleFilters(a), a.$el.find(g.rule_filter).val(a.filter ? a.filter.id : "-1"))
                    }, h)
                }(this.model.root), this.settings.plugins && (this.settings.plugins["unique-filter"] && this.updateDisabledFilters(), this.settings.plugins["bt-selectpicker"] && this.$el.find(g.rule_filter).selectpicker("render")), this.settings.default_filter) try {
    ...
    }), f.define("filter-description", function(a) {
        ...
        }) : "popover" === a.mode ? ($.fn.popover && $.fn.popover.Constructor && $.fn.popover.Constructor.prototype.fixTitle || k.error("MissingLibrary", 'Bootstrap Popover is required to use "filter-description" plugin. Get it here: http://getbootstrap.com'), this.on("afterUpdateRuleFilter", function(b, c) {
            var d = c.$el.find("button.filter-description");
            c.filter && c.filter.description ? (0 === d.length ? (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="popover"><i class="' + a.icon + '"></i></button>'), d.prependTo(c.$el.find(g.rule_actions)), d.popover({
                placement: "left",
                container: "body",
                html: !0
        ...
        })) : "bootbox" === a.mode && ("bootbox" in window || k.error("MissingLibrary", 'Bootbox is required to use "filter-description" plugin. Get it here: http://bootboxjs.com'), this.on("afterUpdateRuleFilter", function(b, c) {
            var d = c.$el.find("button.filter-description");
            c.filter && c.filter.description ? (0 === d.length && (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="bootbox"><i class="' + a.icon + '"></i></button>'), d.prependTo(c.$el.find(g.rule_actions)), d.on("click", function() {
    ...
    }), f.define("invert", function(a) {
        var c = this;
        this.on("afterInit", function() {
            c.$el.on("click.queryBuilder", "[data-invert=group]", function() {
                var d = $(this).closest(g.group_container);
                c.invert(b(d), a)
            }), a.display_rules_button && a.invert_rules && c.$el.on("click.queryBuilder", "[data-invert=rule]", function() {
                var d = $(this).closest(g.rule_container);
                c.invert(b(d), a)
            })
        }), this.on("getGroupTemplate.filter", function(b, d) {
            var e = $(b.value);
            e.find(g.condition_container).after('<button type="button" class="btn btn-xs btn-default" data-invert="group"><i class="' + a.icon + '"></i> ' + c.lang.invert + "</button>"), b.value = e.prop("outerHTML")
        }), a.display_rules_button && a.invert_rules && this.on("getRuleTemplate.filter", function(b) {
            var d = $(b.value);
            d.find(g.rule_actions).prepend('<button type="button" class="btn btn-xs btn-default" data-invert="rule"><i class="' + a.icon + '"></i> ' + c.lang.invert + "</button>"), b.value = d.prop("outerHTML")
        })
    }, {
        ...
        getMongo: function(a) {
            ...
            var b = this;
            return function c(a) {
                if (a.condition || (a.condition = b.settings.default_condition), -1 === ["AND", "OR"].indexOf(a.condition.toUpperCase()) && k.error("UndefinedMongoCondition", 'Unable to build MongoDB query with condition "{0}"', a.condition), !a.rules) return {};
                var d = [];
                a.rules.forEach(function(a) {
                    if (a.rules && a.rules.length > 0) d.push(c(a));
                        ...
                        void 0 === e && k.error("UndefinedMongoOperator", 'Unknown MongoDB operation for operator "{0}"', a.operator), 0 !== f.nb_inputs && (a.value instanceof Array || (a.value = [a.value]), a.value.forEach(function(b) {
                            if (a.field == "http_code" || a.field == "bytes_sent" || a.field == "time_elapsed" || a.field == "bytes_received" ) {
                                a.type="integer";
                            }
        ...
        getRulesFromMongo: function(a) {
            ...
            return function e(a) {
                var f = Object.keys(a);
                f.length > 1 && k.error("MongoParse", "Invalid MongoDB query format"), c[f[0].toLowerCase()] || k.error("UndefinedMongoCondition", 'Unable to build MongoDB query with condition "{0}"', f[0]);
                var g = a[f[0]],
                    h = [];
    ...
    }), g.rule_and_group_containers = g.rule_container + ", " + g.group_container, f.define("sortable", function(a) {
        this.on("afterInit", function(a) {
            $.event.props.push("dataTransfer");
            var c, d, f = a.builder;
            f.$el.on("mouseover.queryBuilder", ".drag-handle", function() {
                f.$el.find(g.rule_and_group_containers).attr("draggable", !0)
            }), f.$el.on("mouseout.queryBuilder", ".drag-handle", function() {
                f.$el.find(g.rule_and_group_containers).removeAttr("draggable")
                ...
                a.preventDefault(), a.stopPropagation(), d.$el.show(), c.drop(), f.$el.find(g.rule_and_group_containers).removeAttr("draggable"), f.trigger("afterMove", d), d = c = null
            })
            ...
            if (c > 1) {
                var d = $(b.value);
                d.find(g.condition_container).after('<div class="drag-handle"><i class="' + a.icon + '"></i></div>'), b.value = d.prop("outerHTML")
            }
        }), this.on("getRuleTemplate.filter", function(b) {
            var c = $(b.value);
            c.find(g.rule_header).after('<div class="drag-handle"><i class="' + a.icon + '"></i></div>'), b.value = c.prop("outerHTML")
        })
    }, {
        ...
        getSQL: function(a, b, c) {
            ...
            var d = this,
                e = function f(c) {
                    if (c.condition || (c.condition = d.settings.default_condition), -1 === ["AND", "OR"].indexOf(c.condition.toUpperCase()) && k.error("UndefinedSQLCondition", 'Unable to build SQL query with condition "{0}"', c.condition), !c.rules) return "";
                    var e = [];
                    return c.rules.forEach(function(c) {
                        if (c.rules && c.rules.length > 0) e.push("(" + b + f(c) + b + ")" + b);
                        else {
                            var g = d.settings.sqlOperators[c.operator],
                                h = d.getOperatorByType(c.operator),
                                i = "";
                            void 0 === g && k.error("UndefinedSQLOperator", 'Unknown SQL operation for operator "{0}"', c.operator), 0 !== h.nb_inputs && (c.value instanceof Array || (c.value = [c.value]), c.value.forEach(function(b, d) {
                                d > 0 && (i += g.sep), "integer" == c.type || "double" == c.type || "boolean" == c.type ? b = k.changeType(b, c.type, !0) : a || (b = k.escapeString(b)), g.mod && (b = k.fmt(g.mod, b)), a ? i += a.add(c, b) : ("string" == typeof b && (b = "'" + b + "'"), i += b)
                            })), e.push(c.field + " " + g.op.replace(/\?/, i))
                        }
                    }), e.join(" " + c.condition + b)
                }(c);
            return a ? {
                sql: e,
                params: a.run()
        ...
        getRulesFromSQL: function(a, b) {
            ...
            "string" == typeof a && (a = {
                sql: a
            }), "string" == typeof b && (b = this.settings.sqlRuleStatement[b](a.params), a.sql = b.esc(a.sql)), 0 !== a.sql.toUpperCase().indexOf("SELECT") && (a.sql = "SELECT * FROM table WHERE " + a.sql);
            var d = SQLParser.parse(a.sql);
            d.where || k.error("SQLParse", "No WHERE clause found");
            var e = {
                    condition: this.settings.default_condition,
                    rules: []
                },
            ...
            return function g(a, d) {
                if (-1 !== ["AND", "OR"].indexOf(a.operation.toUpperCase())) {
                    d > 0 && f.condition != a.operation.toUpperCase() && (f.rules.push({
                        condition: c.settings.default_condition,
                        rules: []
                    }), f = f.rules[f.rules.length - 1]), f.condition = a.operation.toUpperCase(), d++;
                    var e = f;
                    g(a.left, d), f = e, g(a.right, d)
                } else {
                    void 0 !== a.left.value && void 0 !== a.right.value || k.error("SQLParse", "Missing field and/or value"), $.isPlainObject(a.right.value) && k.error("SQLParse", "Value format not supported for {0}.", a.left.value);
                    var h;
                    h = $.isArray(a.right.value) ? a.right.value.map(function(a) {
                        return a.value
                    }) : a.right.value, b && (h = $.isArray(h) ? h.map(b.parse) : b.parse(h));
                    var i = a.operation.toUpperCase();
                    "<>" == i && (i = "!=");
                    var j;
                    j = "NOT LIKE" == i ? c.settings.sqlRuleOperator.LIKE : c.settings.sqlRuleOperator[i], void 0 === j && k.error("UndefinedSQLOperator", 'Invalid SQL operation "{0}".', a.operation);
                    var l = j.call(this, h, a.operation);
                    "NOT LIKE" == i && (l.op = "not_" + l.op);
                    var m = a.left.values.join(".");
                    f.rules.push({
                        id: c.change("getSQLFieldID", m, h),
                        field: m,
                        operator: l.op,
                        value: l.val
                    })
                }
            }(d.where.conditions, 0), e
        },
        setRulesFromSQL: function(a, b) {
            this.setRules(this.getRulesFromSQL(a, b))
        }
    }), f.define("unique-filter", function() {
        ...
        applyDisabledFilters: function(a) {
            var b = a ? a.builder : this;
            b.$el.find(g.filter_container + " option").prop("disabled", !1), $.each(b.status.used_filters, function(a, c) {
                0 === c.length ? b.$el.find(g.filter_container + ' option[value="' + a + '"]:not(:selected)').prop("disabled", !0) : c.forEach(function(b) {
                    b.each(function(b) {
                        b.$el.find(g.filter_container + ' option[value="' + a + '"]:not(:selected)').prop("disabled", !0)
                    })
                })
            }), b.settings.plugins && b.settings.plugins["bt-selectpicker"] && b.$el.find(g.rule_filter).selectpicker("render")
        }
    }), f.regional.en = {
        __locale: "English (en)",
