...
__doc__        = """This migration script update WL/BL Rules set"""
...
if __name__ == '__main__':
    ...
    for app in apps:
        try:
            ...
            wl_bl_ruleset = ModSecRulesSet(name="{} whitelist/blacklist".format(app.name), type_rule='wlbl')
            wl_bl_ruleset.save()
            ...
            ModSecRulesSet.objects.with_id(ObjectId(app.whitelist)).delete()
        except:
            pass