...
if [ "$(/bin/cat /usr/local/etc/sudoers.d/vulture_sudoers | /usr/bin/grep "vlt-sys ALL=NOPASSWD:/home/vlt-gui/vulture/crontab/vlt-sys/dump_mongodb_vulture.sh")" != "" ]
then
...
vlt-sys ALL=NOPASSWD:/home/vlt-gui/vulture/crontab/vlt-sys/dump_mongodb_vulture.sh
