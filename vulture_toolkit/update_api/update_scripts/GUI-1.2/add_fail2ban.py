...
from gui.models.system_settings import Cluster, Fail2banSettings

def update():
	cluster = Cluster.objects.get()
	for node in cluster.members:
		if not node.system_settings.fail2ban_settings:
			node.system_settings.fail2ban_settings = Fail2banSettings()
			node.save()
