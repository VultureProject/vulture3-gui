...
/usr/sbin/pkg install -y python37 py37-setuptools py37-sqlite3 py37-kerberos && echo "OK" || (echo "KO" && echo "[!] Please install following packages manually : python37 py37-setuptools py37-sqlite3 py37-kerberos")
